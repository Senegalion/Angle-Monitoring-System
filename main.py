...
def visualize_table(points_used_to_calculate_angles, acceptable_ranges_of_the_points):
    ...
    # Initialize last_angles if None
...
acceptable_ranges = [[90, 90], [90, 105], [75, 90], [90, 105], [0, 5], [-30, 5]]
